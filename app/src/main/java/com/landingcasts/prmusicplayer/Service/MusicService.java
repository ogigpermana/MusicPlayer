package com.landingcasts.prmusicplayer.Service;
...
import com.landingcasts.prmusicplayer.Data.Song;
import com.landingcasts.prmusicplayer.R;
import com.landingcasts.prmusicplayer.SongListActivity;

public class MusicService extends Service implements AudioManager.OnAudioFocusChangeListener{
    String LOG_CLASS = "MusicService";
    public static MediaPlayer mp;
    int NOTIFICATION_ID = 1111;
    public static final String NOTIFY_PREVIOUS = "com.landingcasts.prmusicplayer.previous";
    public static final String NOTIFY_DELETE = "com.landingcasts.prmusicplayer.delete";
    public static final String NOTIFY_PAUSE = "com.landingcasts.prmusicplayer.pause";
    public static final String NOTIFY_PLAY = "com.landingcasts.prmusicplayer.play";
    public static final String NOTIFY_NEXT = "com.landingcasts.prmusicplayer.next";
